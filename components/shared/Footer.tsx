        ...
        <footer className="bg-gray-50 text-black shadow mt-52">
            ...
            <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                ...
                <div id='contact-us' className='p-2 sm:text-left'>
                    <p className=' text-gray-500 block sm:text-center'>Reach out to us via Mail or Whatsapp  <span aria-hidden="true">→</span> <br />
                ...
                <span className="block text-sm  sm:text-center text-gray-500">
                    © 2025 <Link href="/"><span className="hover:underline">Appvarsity</span></Link>. All Rights Reserved.
                </span>
            </div>
        </footer>
    )

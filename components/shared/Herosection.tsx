        ...
        >
          ...
          <div className="mt-8 flex gap-3 flex-wrap justify-center">
            ...
            <Link href='https://wa.me/2349068406794' target="_blank" rel="noopener noreferrer">
              <button className='inline-flex items-center gap-2 bg-transparent border border-[#d9d8d0] hover:border-[#b7b7af] hover:bg-[#efeee9] transition-[background,transform,box-shadow] hover:-translate-y-0.5 px-6 py-3.5 rounded-[7px] text-sm font-semibold text-[#292a26]'>
        ...
        <div className="rounded-[18px] border border-[#e2e1da] bg-white overflow-hidden shadow-[0_24px_70px_rgba(41,42,38,0.12)]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-[#e2e1da]">
            ...
            <div className="p-6 flex flex-col items-center justify-center text-center gap-3">
              ...
              <p className="text-sm text-[#6c6e65] max-w-[220px]">

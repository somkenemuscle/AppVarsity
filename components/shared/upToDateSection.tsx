...
export default function Uptodate() {
    return (
        <div className="px-8">
            <div className="bg-neutral-900 max-w-6xl border-2 border-gray-600 mx-auto px-7 rounded-xl py-14 my-20 font-sans">
                <div className="flex flex-col justify-center items-start md:flex-row md:items-center gap-3">
                ...
                <p className="mt-4 pl-1 text-gray-400 mx-auto font-light font-sans tracking-wide max-w-2xl text-left md:text-center">
                ...
                <p className="mt-6 text-gray-300 text-left  md:text-center font-semibold"><i>@Appvarsity 2025</i></p>
            </div>
        </div>

...
function FeedbackPage() {
    return (
        <div className="lg:max-w-3xl">
            ...
            <p className="mt-7 text-gray-400 font-light">These following are the steps that need to be taken in order to fill out the form</p>

            <ol className="mt-4 list-decimal pl-5 text-gray-400 font-light">
            ...
            <p className="mt-3 text-gray-500 font-light">Note: If you are using a macbook you can open using the Numbers application</p>

            <p className="mt-5 font-light text-gray-400">Below are screenshots of how the feedback and status report forms should appear once completed:</p>

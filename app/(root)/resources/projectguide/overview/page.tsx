...
function OverviewPage() {
  return (
    <div className="lg:max-w-3xl">
      ...
      <p className="font-light mt-7 text-[#777970]">
        ...
        Please reply with a message in the following format: <span className="text-[#8c8e84]">'Good day, I am [Your Name] and I am acknowledging the e-project.'</span>
      </p>

...
function DocumentationPage() {
    return (
        <div className="lg:max-w-3xl">
            ...
            <p className="text-[#777970] font-light mt-5">NB: Your report should be created in Google Docs and saved as a PDF.</p>

            <div className="mt-8 mb-8">
                <Accordion type="single" collapsible className="w-full">
                    <AccordionItem value='q1' className="border border-[#e2e1da] rounded-xl px-5">
                        ...
                        <AccordionContent className="text-[#777970] text-sm">The highest score for a project at Aptech Maryland, as of today, is 75/100.</AccordionContent>
                    </AccordionItem>
                </Accordion>
            </div>

            <p className="mt-5 font-light text-[#777970]">The following are links to the project pdf reports that scored between 70 and 75 out of 100, showcasing
            ...
            <p className="mt-5 font-light text-[#777970]">

...
function SubmissionPage() {
    return (
        <div className="lg:max-w-3xl">
            ...
            <ol className="ml-4 mt-6 list-decimal font-light text-gray-400">
                <li>Visit the website
                    <Link className="text-indigo-400 hover:underline" href="https://www.mediafire.com/" target="_blank" rel="noopener noreferrer"> MediaFire </Link>
                </li>
            ...
            <p className="font-light mt-7 mb-10 text-gray-300">

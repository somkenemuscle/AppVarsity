...
function SubmissionPage() {
    return (
        <div className="lg:max-w-3xl">
            ...
            <p className="mt-3 font-light text-[#777970]">
                Below, I will show you how to use MediaFire and obtain the URL for your ZIP folder:
            </p>

            <ol className="ml-4 mt-6 list-decimal font-light text-[#777970]">
            ...
            <p className="mt-10 text-[#777970] font-light">
            ...
            <p className="font-light mt-7 mb-10 text-[#5c5e54]">

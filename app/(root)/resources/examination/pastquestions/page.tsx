...
function PastQuestionsPage() {
    return (
        <div className="lg:max-w-4xl">
            ...
            <p className="font-semibold mb-6 text-[#292a26] dark:text-[#f4f2ec]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {pastQuestionPdflinks.map((pdfQuestions, i) => (
                    <a
                        ...
                        className="group flex items-center gap-4 rounded-2xl border border-[#e2e1da] bg-white p-4 shadow-[0_1px_2px_rgba(41,42,38,0.03)] transition-all duration-300 ease-out hover:-translate-y-1 hover:border-[#4f46e5]/30 hover:shadow-[0_16px_32px_-16px_rgba(79,70,229,0.2)] dark:border-[#26271f] dark:bg-[#1b1c18] dark:shadow-none"
                    >
                        ...
                        <div className="min-w-0 flex-1">
                            <p className="truncate text-sm font-semibold text-[#292a26] dark:text-[#f4f2ec]">{pdfQuestions.course.trim()}</p>
                            <p className="mt-0.5 text-xs text-[#8c8e84] dark:text-[#8a8c80]">PDF Document</p>
                        </div>
                        <Download className="h-4 w-4 shrink-0 text-[#c9c8be] transition-colors group-hover:text-[#4f46e5] dark:text-[#3a3c32]" />
                    </a>
                ))}
            </div>

            <p className="font-light mt-8 text-[#777970] dark:text-[#9a9c8d]">

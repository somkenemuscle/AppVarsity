...
function MiddlesexInformationPage() {
    return (
        <div className="lg:max-w-4xl">
            ...
            <div className="flex flex-col items-center rounded-3xl border border-[#e2e1da] bg-white px-6 py-16 text-center shadow-[0_1px_2px_rgba(41,42,38,0.03)]">
                <span className="flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-[#fdeecb] to-[#fbe1a3] text-[#7a5c0e]">
                    <Construction className="h-6 w-6" />
                </span>
                <h2 className="mt-6 font-display text-xl font-semibold text-[#292a26]">Coming Soon</h2>
                <p className="mt-3 max-w-md text-sm leading-relaxed text-[#777970]">
                ...
                <p className="mt-2 max-w-md text-sm leading-relaxed text-[#777970]">

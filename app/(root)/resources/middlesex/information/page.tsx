...
function MiddlesexInformationPage() {
    return (
        <div className="lg:max-w-3xl">
            ...
            />
            <p className="text-[#777970] font-light">
                ...
                <Link href="mailto:appvarsitytech@gmail.com"><span className='font-normal hover:underline text-[#4f46e5]'> appvarsitytech@gmail.com </span></Link>
                ||
                <Link href='https://wa.me/2349068406794'><span className='text-[#4f46e5] hover:underline font-normal'> +234(9068406794) </span></Link>
